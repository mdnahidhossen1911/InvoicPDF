...
class InvoicePdf {
  ...
  pw.Widget buildHeader() {
    return pw.Column(
      ...
      children: [
        pw.Text('TSM SHOP', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
        pw.Text('123 Main Street, City, Country'),
        pw.Text('Email:nahid@gmail.com'),
        pw.Text('Phone: +880 15XXXXXXX'),
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text('$subprice TK', style: pw.TextStyle(fontSize: 18)),
                ],
              ),
            ],
          ),
